...
namespace BulkyWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                shoppingCart.Product.ProductImages = productImages.Where(x => x.ProductId == shoppingCart.Product.Id).ToList();
        ...
        public IActionResult OrderConfirmation(int Id)
        {
            ...
            {
                //this is an order by confirmation
            ...
            _emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "New Order", $"<p>Order Confirmed. Order Id - {orderHeader.Id}</p>");
